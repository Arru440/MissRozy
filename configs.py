...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','https://impossible-claudelle-techboy.koyeb.app/') else APP_NAME+'.herokuapp.com'
...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002096742279")).split())) 
